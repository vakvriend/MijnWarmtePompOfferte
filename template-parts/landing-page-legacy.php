...
$qvantum_types = wc_meta_rows('wc_qvantum_types', [
  ...
  ['🌍','Qvantum QG — Water/water warmtepomp','Voor bodem- of brontoepassingen. Hoogste rendement (COP 4-6). Vakvriend verzorgt de grondboringen en vergunning.'],
], 3);
...
<section id="faq" class="vk-section vk-bg-licht">
  <div class="vk-container">
    ...
    <div class="vk-faq-lijst">
      <?php
      $faqs=[
        ["Wat is het verschil tussen Qvantum en Nibe?","Qvantum onderscheidt zich door de thermische batterij in elk systeem — de warmtepomp slaat energie op bij lage stroomprijzen en gebruikt die later. De QE ventilatiepompen werken zonder buitenunit en zijn in combinatie met de QS-unit ook een volwaardige WTW-unit. Nibe biedt meer modelkeuze inclusief hybride warmtepompen en een breed bodemwarmtepomp-assortiment. Vakvriend adviseert gratis welk merk en model het beste bij uw situatie past."],
        ...
        ["Wat is de Qvantum QE met thermische batterij?","De Qvantum QE is een ventilatie warmtepomp die energie onttrekt aan de afvoerventilatielucht van uw woning. Het geïntegreerde buffervat fungeert als thermische batterij: bij lage of negatieve stroomprijzen laadt de warmtepomp het vat op tot 90°C. Die opgeslagen warmte wordt later benut als stroom duur is. In combinatie met de Qvantum QS-unit verzorgt het systeem ook gebalanceerde WTW-ventilatie. Ideaal voor goed geïsoleerde woningen en appartementen zonder buitenunit."],
