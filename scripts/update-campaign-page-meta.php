...
foreach ($pages as $page) {
    ...
    $base = array(
        ...
        'wc_meta_desc'         => 'Vraag vrijblijvend warmtepompadvies aan' . $in_city . '. Vakvriend berekent subsidie, besparing en installatiekosten voor Qvantum, Nibe en hybride systemen.',
