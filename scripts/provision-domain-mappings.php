...
function vk_page_meta($spec) {
    ...
    if ($type === 'qvantum') {
        ...
        $meta['wc_meta_title'] = 'Qvantum warmtepomp advies | Vakvriend installateur';
        $meta['wc_meta_desc'] = 'Vraag vrijblijvend Qvantum warmtepompadvies aan. Vakvriend berekent subsidie, besparing en installatiekosten voor QA, QE en QG systemen.';
        $meta['wc_focus_keyword'] = 'qvantum warmtepomp';
    } elseif ($type === 'compare') {
        $meta['wc_hero_titel'] = 'Warmtepomp advies vergelijken';
        ...
        $meta['wc_meta_title'] = 'Warmtepomp advies vergelijken | Gratis en vrijblijvende woningcheck';
        $meta['wc_meta_desc'] = 'Vergelijk warmtepomp adviess en krijg vrijblijvend advies over subsidie, besparing en het juiste systeem voor uw woning.';
        $meta['wc_focus_keyword'] = 'warmtepomp adviess vergelijken';
    } elseif ($type === 'brand') {
