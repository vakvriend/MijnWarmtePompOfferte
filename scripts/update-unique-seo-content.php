...
$special = array(
    ...
    'Warmtepomp Vergelijken' => array(
        ...
        'wc_stad' => 'Nederland',
        'wc_regio' => 'heel Nederland',
        'wc_meta_title' => 'Warmtepomp advies vergelijken | Qvantum, Nibe en hybride',
        'wc_meta_desc' => 'Vergelijk warmtepomp adviess op subsidie, geluid, rendement, tapwater, installatiekosten en geschiktheid voor uw woning.',
        'wc_focus_keyword' => 'warmtepomp adviess vergelijken',
        'wc_hero_titel' => 'Warmtepomp advies vergelijken',
        ...
        'wc_lokale_h2' => 'Advies vergelijken zonder appels met peren',
        'wc_lokale_intro' => 'Warmtepompadviezen lijken vaak op elkaar, maar de verschillen zitten in vermogen, boilervoorziening, geluid, leidingwerk, regeling en subsidiebedrag.',
        'wc_lokale_alinea1' => 'Een advies voor hybride verwarmen is niet vergelijkbaar met een volledig elektrische lucht/water warmtepomp. Ook Qvantum en Nibe lossen tapwater en regeling op een andere manier op.',
        ...
        'wc_lokale_alinea3' => 'Zo voorkomt u dat u kiest voor de goedkoopste oplossing, terwijl een iets andere oplossing beter past bij uw woning en comfortwensen.',
        'wc_lokale_faq_v1' => 'Waar moet ik op letten bij warmtepomp adviess?',
        ...
        'wc_lokale_faq_v2' => 'Is de goedkoopste oplossing meestal de beste?',
    ...
    'Mijn Warmtepomp Offerte' => array(
        ...
        'wc_stad' => 'Nederland',
        'wc_regio' => 'heel Nederland',
        'wc_meta_title' => 'Warmtepomp advies | Vrijblijvende woningcheck | Vakvriend',
        'wc_meta_desc' => 'Start uw persoonlijke warmtepomp woningcheck met besparingsberekening en advies over Qvantum, Nibe of hybride.',
        'wc_focus_keyword' => 'warmtepomp advies',
        'wc_hero_titel' => 'Mijn warmtepomp woningcheck starten',
        'wc_hero_subtitel' => 'Ontvang praktisch warmtepompadvies dat past bij uw woning, verbruik en comfortwensen. Vakvriend rekent subsidie en besparing meteen mee.',
        'wc_lokale_h2' => 'Een woningcheck die begint bij uw situatie',
        ...
        'wc_lokale_alinea1' => 'Vakvriend kijkt eerst naar de woning en pas daarna naar het merk of model. Daardoor krijgt u advies dat technisch klopt.',
        'wc_lokale_alinea2' => 'In de woningcheck ziet u welke route logisch is, welke ISDE-subsidie mogelijk is en welke besparing realistisch is bij uw verbruik.',
        'wc_lokale_alinea3' => 'U kunt Qvantum, Nibe, hybride, warmtepompboilers en bodemwarmte naast elkaar laten beoordelen. Zo kiest u rustig en met feiten.',
        'wc_lokale_faq_v1' => 'Is de warmtepomp woningcheck gratis?',
        'wc_lokale_faq_a1' => 'Ja, de eerste woningcheck is vrijblijvend.',
        ...
        'wc_lokale_faq_v3' => 'Krijg ik direct een definitief advies?',
        'wc_lokale_faq_a3' => 'Online geven we alvast richting en subsidie-inschatting. Voor definitief advies beoordeelt Vakvriend de woning, foto’s en praktische installatiepunten.',
        'wc_form_titel' => 'Start uw persoonlijke woningcheck',
        'wc_form_subtitel' => 'Vul woningtype, systeemwens en verbruik in en ontvang advies dat bij uw huis past.',
        'wc_voordelen_titel' => 'Uw advies begint bij de woning',
        'wc_voordelen_lead' => 'Deze pagina is bedoeld voor bezoekers die nog niet weten welk systeem past en eerst duidelijke richting willen.',
    ),
    'Warmtepomp Qvantum' => array(
        'status' => 'seo-unique-v2',
        'wc_stad' => 'Nederland',
        'wc_regio' => 'heel Nederland',
        'wc_meta_title' => 'Qvantum warmtepomp advies | QA, QE en QG specialist',
        ...
        'wc_hero_titel' => 'Qvantum warmtepomp woningcheck starten',
...
function vk_local_meta($title, $spec, $index) {
    ...
    $intro_styles = array(
        ...
        '{city} verdient een advies waarin de praktische kanten helder zijn: waar komt de unit, hoe blijft het stil en wat doet het systeem op koude dagen?',
    );
    $hero_styles = array(
        ...
        'Laat uw woning in {city} beoordelen voordat u adviezen vergelijkt. Zo voorkomt u een te klein systeem, geluidsgedoe of onnodige kosten.',
        ...
        'Ontdek welke warmtepomp bij uw woning in {city} past en ontvang een advies waarin ruimte, regeling, tapwater en ISDE apart zijn uitgewerkt.',
        'Voor woningen in {city} vergelijkt Vakvriend Qvantum, Nibe, hybride, warmtepompboilers en bodemwarmte op technische geschiktheid.',
    ...
    $angle_styles = array(
        ...
        'De lokale nuance is helder: {focus}. De advies moet dus uitleggen waarom juist dat systeem past.',
    ...
    $attention_styles = array(
        ...
        'Een belangrijk deel van het plan is {attention}. Dat zetten we begrijpelijk in de advies, zodat u weet waar u ja tegen zegt.',
    ...
    $closing_styles = array(
        ...
        'De advies laat zien wat direct kan, wat voorbereiding vraagt en waar u eventueel beter nog niet in moet investeren.',
    ...
    $extra_openers = array(
        ...
        'Het verschil tussen een redelijke advies en een sterke advies zit vaak in de kleine regels.',
    ...
    $extra_middle = array(
        ...
        'Een lage advies zonder uitleg over leidingwerk, elektra en regeling is geen voordeel maar een risico.',
    ...
    $extra_close = array(
        ...
        'Zo wordt de advies geen verzameling artikelnummers, maar een plan voor minder gasverbruik en meer zekerheid.',
        'U weet na de opname welke keuze verstandig is, welke keuze kan wachten en welke oplossing we juist afraden.',
        'Dat maakt de aanvraag niet alleen sneller, maar vooral bruikbaarder wanneer u adviezen naast elkaar legt.',
    ...
    $extra = 'Vakvriend kijkt per woning naar warmteverlies, bestaande radiatoren of vloerverwarming, tapwatergebruik en de beschikbare installatieruimte.' . "\n\n" .
        ...
        'Zo wordt het advies concreet: welk systeem past, wat moet worden voorbereid en welke investering blijft over na subsidie.';
    $profile = $index % 8;
    ...
    $boring_cards = array(
        ...
        'Boring en vergunning horen niet als losse verrassing achteraf in de advies. Ze worden vanaf het begin meegenomen.',
    ...
    $qvantum_leads_clean = array(
        'Qvantum is vooral interessant wanneer warm tapwater, ruimtebeslag en systeemopbouw netjes moeten samenkomen. De techniek vraagt wel om een goede opname: warmteverlies, afgiftesysteem, ventilatie en leidingwerk bepalen of QA, QE of QG verstandig is.',
        'Een Qvantum-oplossing kan sterk zijn bij woningen waar een groot boilervat onhandig is. Vakvriend kijkt dan niet alleen naar het toestel, maar ook naar douchecomfort, regeling, geluidspositie en de beschikbare ruimte voor montage.',
        'Qvantum werkt anders dan een klassieke warmtepomp met boilervat. Daarom beoordelen we het systeem apart: wat vraagt de woning aan vermogen, hoeveel warm water is nodig en welke variant past bij de bestaande installatie?',
        'De meerwaarde van Qvantum zit niet in een mooi verkoopverhaal, maar in de combinatie van warmtepomp, thermische batterij en warm tapwater zonder voorraadvat. Dat moet per woning technisch kloppen voordat we het adviseren.',
    );
    $qvantum_uitleg_clean = array(
        'Een Qvantum bewaart geen douchewater in een groot vat. De batterij bewaart warmte. Op het moment dat u warm water vraagt, stroomt koud leidingwater langs een platenwisselaar. Die wisselaar haalt warmte uit de batterij en maakt het water direct warm. Simpel gezegd: er staat geen badkuip water klaar, er staat warmte klaar.',
        'De thermische batterij is te vergelijken met een voorraad warmte, niet met een voorraad drinkwater. Draait u de warme kraan open, dan wordt vers leidingwater door een platenwisselaar geleid. Die geeft de opgeslagen warmte razendsnel door aan het tapwater.',
        'Bij Qvantum zit het comfort in opgeslagen warmte. Het tapwater blijft gewoon vers leidingwater en wordt pas verwarmd wanneer u het nodig heeft. Dat gebeurt via een platenwisselaar die zijn warmte uit de thermische batterij haalt.',
        'Denk aan de thermische batterij als een warme steen die energie vasthoudt. Het douchewater zit daar niet in. Het water loopt langs een platenwisselaar, pakt warmte mee uit de batterij en komt warm uit de kraan.',
    );
    $qvantum_type_clean = array(
        "💨|QA lucht/water|De meest directe route wanneer een buitenunit goed geplaatst kan worden. We letten op vermogen, geluid, leidingroute, onderhoudsruimte en de waterzijdige afstelling van radiatoren of vloerverwarming.\n🌬️|QE ventilatie|Interessant wanneer afvoerlucht bruikbaar is en een buitenunit minder logisch is. Ventilatiecapaciteit, luchtkanalen en tapwaterprofiel moeten dan echt worden gecontroleerd.\n🌍|QG bronoplossing|Een bodemgebonden systeem kan stabiel en stil werken, maar vraagt bronontwerp, goede lage temperatuur afgifte en een investering die bij de woning past.",
        "💨|QA bij buitenruimte|Geschikt wanneer tuin, dak of zijgevel voldoende ruimte geeft voor een stille en servicebare opstelling. Vooral montagekwaliteit en inregeling bepalen het resultaat.\n🌬️|QE zonder buitenunit|Een compacte route waarbij warmte uit ventilatielucht wordt benut. Niet voor elke woning geschikt, wel waardevol als de luchtstromen en warmtevraag passen.\n🌍|QG met bodembron|Technisch sterk bij de juiste randvoorwaarden. We adviseren dit alleen wanneer bron, vergunning, afgiftesysteem en budget samen logisch zijn.",
        "🔋|Thermische batterij|Bij alle Qvantum-routes draait het om warmte opslaan en slim afgeven. Dat kan ruimte besparen, maar vraagt een goede controle op comfort en leidingwerk.\n🚿|Tapwater op aanvraag|Warm water wordt vers gemaakt via de platenwisselaar. Daarom tellen douchegedrag, debiet en leidinglengtes mee in het advies.\n⚙️|Variant na opname|QA, QE en QG lossen verschillende situaties op. De keuze volgt uit de woning, niet uit een standaardpakket.",
        "💨|Buitenlucht als bron|QA gebruikt buitenlucht en vraagt een doordachte opstelplek. Geluid, trillingen en bereikbaarheid moeten vooraf worden ontworpen.\n🌬️|Ventilatielucht benutten|QE gebruikt warmte uit afgevoerde lucht. Dit werkt alleen goed als ventilatie en warmtevraag bij elkaar passen.\n🌍|Bronwarmte toepassen|QG komt pas in beeld als de woning geschikt is voor lage temperatuur verwarming en de boring praktisch uitvoerbaar is.",
    );
    $qvantum_usp_clean = array(
        "Geen klassiek boilervat|Tapwater wordt niet langdurig opgeslagen, maar op aanvraag verwarmd.\nThermische batterij|De batterij bewaart warmte en geeft die af voor verwarming en warm water.\nCompacte systeemopbouw|Interessant wanneer technische ruimte beperkt is.\nMerkonafhankelijk beoordeeld|Qvantum wordt altijd naast Nibe, hybride en bodemwarmte gelegd.",
        "Vers warm water|De platenwisselaar verwarmt leidingwater pas wanneer u de kraan opent.\nRuimte besparen|Geen groot tapwatervat kan een voordeel zijn bij beperkte plaatsingsruimte.\nGoede uitleg nodig|De techniek is sterk, maar moet helder worden uitgelegd voordat u kiest.\nComfort apart berekend|Tapwater, verwarming en regeling krijgen elk een eigen beoordeling.",
        "Warmte op voorraad|De batterij slaat energie op, niet het drinkwater zelf.\nQA, QE en QG|Elke variant heeft eigen eisen voor bron, ventilatie of buitenunit.\nSubsidie meegenomen|ISDE hangt af van toesteltype, vermogen en voorwaarden.\nGeen merkdruk|Als een ander systeem beter past, zeggen we dat gewoon.",
        "Slim bij ruimtegebrek|Voor sommige woningen is een thermische batterij praktischer dan een groot boilervat.\nTapwater via wisselaar|Vers water wordt direct verwarmd met opgeslagen warmte.\nTechnische opname nodig|Vermogen, comfort en plaatsing moeten vooraf kloppen.\nAlternatieven blijven open|Hybride, Nibe of bodemwarmte kunnen net zo goed de betere keuze zijn.",
    );
    $nibe_type_clean = array(
        "💨|Lucht/water|Een brede en bewezen route voor hybride of all-electric. Belangrijk zijn warmteverlies, geluidsopstelling, binnenmodule en de aanvoertemperatuur die de woning nodig heeft.\n🌍|Bodem/water|Een stille en zuinige oplossing wanneer bron, perceel en lage temperatuur afgifte goed passen. De hogere investering moet wel technisch en financieel te verdedigen zijn.\n⚡|Hybride|Een verstandige tussenstap wanneer radiatoren, isolatie of tapwater nog niet klaar zijn voor volledig elektrisch.",
        "💨|Buitenunit met binnenmodule|Nibe biedt veel configuraties. Daardoor kunnen vermogen, boilerinhoud, regeling en geluid nauwkeuriger worden afgestemd op de woning.\n🌍|Bronwarmte|Sterk voor lange termijn comfort, mits boring, vergunning en afgiftesysteem goed zijn voorbereid.\n🔥|Samen met cv-ketel|Hybride houdt piekbelasting en tapwater bij de ketel en laat de warmtepomp het grootste deel van de ruimteverwarming doen.",
        "💨|All-electric lucht/water|Geschikt als de woning voldoende lage temperatuur kan verwarmen en tapwater goed is ontworpen.\n🌍|Bodemwarmtepomp|Interessant bij woningen waar stilte, rendement en lange levensduur zwaar wegen.\n⚡|Hybride als eerste stap|Kan gasverbruik sterk verlagen zonder direct de hele installatie om te bouwen.",
        "🔧|Veel configuraties|Nibe is sterk wanneer maatwerk nodig is in vermogen, binnenunit, boiler en regeling.\n🌍|Bron alleen met onderbouwing|Bodemwarmte verdient een aparte berekening, geen snelle aanname.\n🔥|Hybride niet afschrijven|Bij oudere woningen kan hybride technisch verstandiger zijn dan te snel volledig elektrisch gaan.",
    );
    $warmtepomp_type_clean = array(
        "💨|Veel gekozen|Lucht/water warmtepomp|Haalt warmte uit buitenlucht en geeft die af aan radiatoren of vloerverwarming. De kwaliteit zit vooral in juiste dimensionering, stille plaatsing en waterzijdige inregeling.|Geen boring nodig;Hybride of all-electric;Buitenunit goed ontwerpen;Afgiftesysteem controleren;ISDE vaak mogelijk|Qvantum QA of Nibe lucht/water\n🌬️|Compacte toepassing|Ventilatie warmtepomp|Gebruikt warmte uit afvoerlucht. Vooral interessant wanneer ventilatie centraal geregeld is of een buitenunit lastig ligt.|Geen buitenunit;Ventilatiecapaciteit bepalend;Beperkt vermogen;Tapwater goed narekenen;Niet voor elke woning|Qvantum QE\n🌍|Lange termijn|Bodemwarmtepomp|Gebruikt warmte uit de bodem. Technisch sterk, maar alleen logisch wanneer perceel, bron, afgiftesysteem en budget passen.|Stabiel rendement;Weinig buitenunitgeluid;Boring nodig;Hogere investering;Sterk bij lage temperatuur|Nibe bodem/water of Qvantum QG\n🚿|Voor tapwater|Warmtepompboiler|Een tapwater-oplossing voor douche en kraan, niet voor volledige ruimteverwarming. Interessant als warm water eerst aangepakt wordt of als de cv-ketel voorlopig blijft.|Voor tapwater;Boilervat nodig;ISDE vaak mogelijk;Ruimte en geluid beoordelen;Past naast cv of hybride|Nibe, Itho Daalderop of Intergas combinaties",
        "💨|Praktisch in bestaande bouw|Lucht/water|Een nuchtere route met relatief snelle duidelijkheid over prijs, subsidie en montage. Geluid en afgiftevermogen moeten vooraf kloppen.|Breed toepasbaar;Buitenunit vereist;Goede regeling nodig;Hybride mogelijk;All-electric mogelijk|Nibe of Qvantum QA\n🌬️|Zonder buitenunit|Ventilatie|Kan passen wanneer afvoerlucht beschikbaar is en buitenplaatsing gevoelig ligt. De warmtevraag mag dan niet worden overschat.|Ruimtebesparend;Afhankelijk van luchtdebiet;Comfortcheck nodig;Specifieke toepassing;Tapwater kritisch bekijken|Qvantum QE\n🌍|Premium route|Bodem/water|Een bron kan rustig en efficient draaien, maar vraagt meer voorbereiding dan lucht/water.|Bronontwerp nodig;Vergunning mogelijk;Lage temperatuur gewenst;Hogere startkosten;Lange gebruikshorizon|Nibe bodem/water of Qvantum QG\n🚿|Voor tapwater|Warmtepompboiler|Een tapwater-oplossing voor douche en kraan, niet voor volledige ruimteverwarming. Interessant als warm water eerst aangepakt wordt of als de cv-ketel voorlopig blijft.|Voor tapwater;Boilervat nodig;ISDE vaak mogelijk;Ruimte en geluid beoordelen;Past naast cv of hybride|Nibe, Itho Daalderop of Intergas combinaties",
        "💨|Flexibel|Lucht/water|Kan naast een cv-ketel beginnen of volledig elektrisch worden ontworpen. De woning bepaalt de stapgrootte.|Veel systeemkeuze;Geen bronboring;Geluid meenemen;Radiatoren checken;Tapwater apart kiezen|Nibe lucht/water, Qvantum QA\n🌬️|Specifiek|Ventilatie|Niet bedoeld als standaardoplossing voor elke woning, wel interessant wanneer ventilatielucht continu beschikbaar is.|Geen tuinunit;Kanaalwerk belangrijk;Beperkt vermogen;Compact;Opname nodig|Qvantum QE\n🌍|Stabiele bron|Bodem/water|Een bodemwarmtepomp kan technisch de mooiste route zijn als perceel en afgiftesysteem passen.|Stil systeem;Boring/vergunning;Hoge efficientie;Meer voorbereiding;Niet overal rendabel|Nibe bodem/water, Qvantum QG",
        "💨|Eerste rekenspoor|Lucht/water|Vaak de eerste serieuze vergelijking omdat investering, subsidie en plaatsing snel concreet worden.|Snel inzicht;Buitenunit ontwerpen;Hybride mogelijk;All-electric mogelijk;Afgiftevermogen toetsen|Qvantum QA of Nibe\n🌬️|Als buiten lastig is|Ventilatie|Een ventilatievariant kan netter zijn wanneer gevel, dak of tuin geen goede buitenunitpositie biedt.|Geen buitenunit;Ventilatie-eisen;Lager vermogen;Tapwater controleren;Niet universeel|Qvantum QE\n🌍|Wanneer het huis het waard is|Bodemwarmte|Voor woningen met goede randvoorwaarden kan bodemwarmte comfort geven met weinig zichtbaar installatiewerk buiten.|Bronboring;Stabiele temperatuur;Lage temperatuur nodig;Meer voorbereiding;Langetermijnkeuze|Nibe bodem/water of Qvantum QG\n🚿|Voor tapwater|Warmtepompboiler|Een tapwater-oplossing voor douche en kraan, niet voor volledige ruimteverwarming. Interessant als warm water eerst aangepakt wordt of als de cv-ketel voorlopig blijft.|Voor tapwater;Boilervat nodig;ISDE vaak mogelijk;Ruimte en geluid beoordelen;Past naast cv of hybride|Nibe, Itho Daalderop of Intergas combinaties",
    );
    $vv_props_clean = array(
        "📐|Eerst rekenen|Warmteverlies, afgiftesysteem en tapwater bepalen of hybride, all-electric of ventilatie logisch is.\n🚿|Tapwater serieus nemen|Douchegedrag, leidinglengte en hersteltijd worden los beoordeeld van ruimteverwarming.\n🔧|Installatiepraktijk meewegen|Elektra, condensafvoer, leidingroute en servicebaarheid horen in het advies.\n🤝|Geen merkdruk|Als Nibe beter past dan Qvantum of andersom, leggen we dat gewoon uit.",
        "🏠|Geen standaardpakket|De woning bepaalt de route: hybride, Qvantum, Nibe of bronwarmte.\n⚙️|Regeling en afgifte|We controleren of radiatoren, vloerverwarming en regeling lage temperatuur aankunnen.\n🔇|Rustig in gebruik|Geluid, trillingen en nachtbedrijf worden vooraf besproken.\n🧾|Heldere netto prijs|U ziet wat toestel, montage, subsidie en randwerk doen met de investering.",
        "🛠️|Montage vooraf doordacht|Binnenmodule, buitenunit, leidingwerk en elektra worden in samenhang bekeken.\n🌬️|Ventilatie telt mee|Bij ventilatieoplossingen nemen we luchtdebiet en comfort apart mee.\n💧|Warm water apart berekenen|Tapwatercomfort krijgt een eigen controle, zeker bij compacte systemen.\n📊|Realistische besparing|We rekenen met uw gebruik, niet met een ideaal gemiddelde.",
        "📋|Advies dat uitlegt|Geen lijst met artikelnummers, maar uitleg over systeem, plaatsing en subsidie.\n🚿|Comfort boven marketing|Warm water, stilte en verwarming bepalen de kwaliteit in dagelijks gebruik.\n🌍|Bodem alleen waar logisch|Een boring komt pas in beeld als perceel, budget en afgifte passen.\n🛠️|Nazorg inbegrepen|Na installatie blijft regeling en gebruik onderdeel van het werk.",
    );
    $workflow_clean = array(
        "01|Woningprofiel vastleggen|We starten met gasverbruik, bouwjaar, isolatie, afgiftesysteem en foto’s van technische ruimte of buitenplek.\n02|Technische route kiezen|Daarna vergelijken we Qvantum, Nibe, hybride, warmtepompboilers en bodemwarmte op haalbaarheid en comfort.\n03|Uitvoering concreet maken|Leidingroute, elektra, geluid, tapwater en ISDE worden duidelijk uitgewerkt.\n04|Installeren en inregelen|Na montage stellen we het systeem in op comfort, warm water en verbruik.",
        "01|Warmtevraag bepalen|Bouwjaar, isolatie en radiatoren of vloerverwarming geven eerst de bandbreedte voor het vermogen.\n02|Plaatsing beoordelen|We kijken naar buitenunit, binnenmodule, leidingwerk, condensafvoer en onderhoudsruimte.\n03|Advies opbouwen|Toestel, montage, subsidie en voorbereidend werk staan los benoemd.\n04|Opleveren met uitleg|U weet hoe de regeling werkt en wanneer bijsturen nodig is.",
        "01|Niet beginnen bij het merk|Eerst bekijken we wat de woning technisch vraagt.\n02|Knelpunten benoemen|Geluid, elektra, tapwater, ventilatie of vergunning komen vroeg op tafel.\n03|Netto investering tonen|ISDE, toestel, montage en randwerk worden helder uitgesplitst.\n04|Controle na oplevering|We controleren instelling en gebruik, zodat het systeem rustig draait.",
        "01|Aanvraag vertalen naar techniek|We maken van uw gegevens een eerste warmtepomproute.\n02|Afgifte en tapwater controleren|Radiatoren, vloerverwarming en douchecomfort bepalen de juiste opstelling.\n03|Plaatsing ontwerpen|Geluid, leidinglengte en onderhoudsruimte krijgen een vaste plek in het plan.\n04|Subsidie en installatie afronden|Na akkoord begeleiden we uitvoering en ISDE-stukken.",
    );
    ...
    $boringen_kaart_tekst = 'Bodemwarmte nemen we alleen mee wanneer bron, vergunning, afgiftesysteem en investering bij elkaar passen. Als lucht/water of hybride verstandiger is, hoort dat net zo duidelijk in het advies te staan.';
    ...
    return array(
        'wc_ai_content_status' => 'seo-unique-v3-human-copy',
        'wc_meta_title' => 'Warmtepomp ' . $city . ' | Advies voor ' . $region,
        'wc_meta_desc' => 'Uniek warmtepompadvies in ' . $city . ': woningcheck, ISDE-berekening en vergelijking van Qvantum, Nibe, hybride, warmtepompboiler of bodemwarmte.',
        'wc_focus_keyword' => 'warmtepomp ' . strtolower($city),
        'wc_hero_kicker' => 'Gratis en vrijblijvend woningadvies in ' . $city,
        'wc_hero_titel' => 'Ontdek welke warmtepomp past bij uw woning in ' . $city,
        'wc_hero_subtitel' => $hero_sub,
        'wc_form_titel' => 'Gratis en vrijblijvende woningcheck voor ' . $city,
        ...
        'wc_form_benefits' => "Gratis en vrijblijvende woningcheck\nWensen en comfort besproken\nAdvies binnen 24 uur",
        'wc_campaign_proof' => "Vrijblijvend|woningcheck en advies\nISDE|berekening inbegrepen\n24u|reactie op uw aanvraag",
        'wc_topbar_tekst' => $city . ': vrijblijvende warmtepomp woningcheck - reactie binnen 24 uur',
        ...
        'wc_qvantum_cta' => 'Start de woningcheck',
        ...
        'wc_nibe_cta' => 'Start de woningcheck',
...
function vk_special_support_meta($title) {
    $topics = array(
        ...
        'Warmtepomp Vergelijken' => array(
            ...
            'boring' => 'Een bodemadvies lijkt duurder, maar kan logisch zijn als boring, vergunning, bron en lange levensduur goed zijn meegenomen.',
        ),
        'Mijn Warmtepomp Offerte' => array(
            'label' => 'woningcheck',
            ...
            'angle' => 'woninggegevens, verbruik, comfortwensen en subsidie',
            'qvantum' => 'In de woningcheck bekijken we of Qvantum past bij de beschikbare ruimte, tapwaterwens, ventilatie en het idee van warmteopslag zonder groot boilervat.',
            ...
            'boring' => 'Bodemwarmte nemen we alleen mee wanneer perceel, budget, vergunning en warmteverlies dat serieus rechtvaardigen.',
        ),
        'Warmtepomp Qvantum' => array(
    ...
    return array(
        ...
        'wc_vv_intro' => 'Vakvriend vertaalt uw ' . $topic['label'] . ' naar merkonafhankelijk systeemadvies, praktische installatiepunten, ISDE-subsidie en heldere uitleg. U ziet waarom een systeem past, welke randvoorwaarden gelden en welke alternatieven logisch zijn.',
        'wc_werkwijze_eyebrow' => 'Aanpak · ' . $topic['label'],
        'wc_werkwijze_titel' => 'Van vraag naar bruikbare keuze',
        'wc_werkwijze_lead' => 'We starten bij ' . $topic['angle'] . '. Daarna controleren we de woninggegevens en geven we merkonafhankelijk advies over vermogen, plaatsing en subsidie.',
        ...
        'wc_boringen_kaart_tekst' => $topic['boring'] . ' Vakvriend maakt bron, boring en vergunning apart inzichtelijk, zodat duidelijk is wat bodemwarmte praktisch betekent.',
    );
}
