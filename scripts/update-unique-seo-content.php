...
function vk_local_meta($title, $spec, $index) {
    ...
    $types_lead = 'Er is geen warmtepomp die voor iedere woning automatisch goed is. Het juiste systeem hangt af van warmteverlies, isolatie, afgiftesysteem, warmwatergebruik, plaatsing en budget.';
    $vv_intro_sober = 'Vakvriend adviseert merkonafhankelijk. We vergelijken Qvantum, Nibe, hybride en bodemwarmte op basis van woning, verbruik, comfortwens en praktische montage. Het advies moet technisch kloppen voordat er een merk wordt gekozen.';
