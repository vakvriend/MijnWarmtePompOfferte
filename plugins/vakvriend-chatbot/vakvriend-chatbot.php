...
add_action('wp_enqueue_scripts', function() {
    ...
    wp_enqueue_style('vk-chat-widget', plugin_dir_url(__FILE__) . 'chatbot.css', [], '1.0.3');
    wp_enqueue_script('vk-chat-widget', plugin_dir_url(__FILE__) . 'chatbot.js', [], '1.0.3', true);
